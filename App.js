 ...
 import Accomodation from "./Components/Accomodation/Accomodation";
  ...
  function App() {
    const stripePromise = loadStripe(
      "pk_test_51OypdWGLAdTcmP8VCV9F4hrPPqp75rkkmvo5OjdfqLRJy6bGju7ef3dcTpQ6f7uOYSPeNhvu1PV4qFGzXMmHhZ9600EUCk6G9u"
    );
    ...
    //Manages routing configuration for the application.
    const router = createBrowserRouter(
      //create routes from the element passed to it.
      createRoutesFromElements(
        ...
        <Route path="/" element={<Main/>} id="main" exact>
          ...
          <Route id="forgotpassword" path="user/forgetpassword" element={<ForgotPassword/>}/>
    ...
    return ( <div className="App">
      {/*This ensures that the routing fuctionality is available throughout the application. */}
